...
import company.wltea.analyzer.cfg.Configuration;
...
//					}
                ...
                endIndex = path.getPathEnd();
            } else if (index >= endIndex) {//pathMap中找不到index对应的LexemePath
                //len.zhang修改，"共和国|共和|国"的情况，不输出“国”
                //单字不输出
                this.outputSingleCJK(index);
                index++;
            } else {
